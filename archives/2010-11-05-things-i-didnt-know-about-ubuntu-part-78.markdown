...
Steve Beattie points out that [Jockey has a text
interface](http://askubuntu.com/questions/6521/how-can-i-reconfigure-the-nvidia-proprietary-drivers-from-the-command-line-ssh/11464#11464)
as well; for those moments when you’re staring at a console.

To think I would fire up elinks to get the driver after navigating the
nvidia site and then scp over an old Xorg.conf. 
