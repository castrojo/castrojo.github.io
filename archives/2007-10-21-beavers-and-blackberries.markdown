...
This might be old, but I’m slow, but there are a bunch of ads on TV
lately about a drug called Rozerem.

![Rozerem](http://stompbox.typepad.com/photos/uncategorized/2007/10/21/rozerem.jpg)

I don’t even know what this drug does, but the ads are quite weird. A
beaver, Abe Lincoln, and a deep sea diver. In some ads, the beaver is
using a blackberry, doing whatever it is crackberry addicts do. In one,
there’s a crazy blue pony.

A blue pony. I hope in the next one the pony and beaver play chess, that
would be awesome.
