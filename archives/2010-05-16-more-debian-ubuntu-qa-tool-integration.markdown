...
In case you’re a Debian Developer and missed [this
post](http://www.lucas-nussbaum.net/blog/?p=477), you can now subscribe
to Ubuntu bugs for packages you care about. 

I have an action item to investigate if we can do this per person as an
option vs. per package. More to follow in a longer Debian-related post.
