...
On the Friday of the Ubuntu Developer Summit we do 5 minute lightning
talks. Evan Martin from Chromium did a bit on Speed, and why they’re so
obsessed with it. 

To prove his point he compared Chromium’s launch time vs. gcalctool.
Yes, the web browser was launching faster than the calculator. 

I am not sure if Evan knew it or not, but Robert Ancell (one of the
gcalctool guys!) was in the audience. And not content with failure, he
went and [fixed
it](http://bobthegnome.blogspot.com/2010/05/gcalctool-5311.html). The
ball is in your court now Chromium!

(Note: I am not advocating any kind of Calculator acid test or
Calcspider speed test, before anyone gets any bright ideas.)
