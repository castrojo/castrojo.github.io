...
Tomorrow, 15 September at 0900 UTC the following services will
interrupted:

-    [hall-of-fame.ubuntu.com](http://hall-of-fame.ubuntu.com/)

-    [loco.ubuntu.com](http://loco.ubuntu.com/)

-    [mago.ubuntu.com](http://mago.ubuntu.com/)

-    [manpages.ubuntu.com](http://manpages.ubuntu.com/)

-    [qa.ubuntu.com](http://qa.ubuntu.com/)

-    \*.[qa.ubuntu.com](http://qa.ubuntu.com/)

-    [summit.ubuntu.com](http://summit.ubuntu.com/)

-    [ubiquity-feedback.ubuntu.com](http://ubiquity-feedback.ubuntu.com/)

And one for the linaro folks

-    [qatracker.linaro.org](http://qatracker.linaro.org/)

Expected downtime is 90 minutes, but hopefully less.
