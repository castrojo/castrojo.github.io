...
I was on holiday when this happened but I figured it was worth a repost.
As announced by James Page [OpenStack 2014.2.1 is now
available](https://lists.ubuntu.com/archives/ubuntu-server/2014-December/007011.html)
for Ubuntu 14.04 (and 14.10).

Instructions are at the link, you might also want to check the [upstream
release notes](https://wiki.openstack.org/wiki/ReleaseNotes/2014.2.1)
