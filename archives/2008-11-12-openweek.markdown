...
![Ubuntuopenweeksmall](http://stompbox.typepad.com/photos/uncategorized/2008/11/12/ubuntuopenweeksmall.png)

I’d like to thank everyone who participated in [Ubuntu Open
Week](https://wiki.ubuntu.com/UbuntuOpenWeek) this time around,
especially our presenters. For many presenters this was their first Open
Week so the variety of talks continues to grow! Some Ars coverage of
Mark’s talk is
[here](http://arstechnica.com/news.ars/post/20081109-ubuntu-open-week-mark-shuttleworth-speaks.html).
Logs are posted for your viewing pleasure on the Open Week page.

Special thanks go out to [Dylan
McCall](https://edge.launchpad.net/~dylanmccall) for handling the
calendar attachment so that people can subscribe to the schedule. Also a
shout out to the IRC team for their always solid support. Excellent
work!
