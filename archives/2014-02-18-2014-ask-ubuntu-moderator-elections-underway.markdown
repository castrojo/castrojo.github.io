...
It’s that time of the year where elections are needed for 2 available
moderator positions on [Ask Ubuntu](http://askubuntu.com).

Here are the list of [nominees](http://askubuntu.com/election?cb=1), if
you have 150 rep on the site you can cast a vote.

![](http://www.jorgecastro.org/images/voted.gif){.center}

The primary closes in 3 days, after which the election begins. Please
take the time to read the statements from each of the candidates and
cast a vote!
