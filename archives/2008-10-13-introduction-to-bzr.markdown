...
Ubuntu Michigan LoCo stud and overall nice guy [Rick
Harding](http://mitechie.com/) has just published an Introduction to Bzr
in [Python Magazine](http://pymag.phparch.com/).

[![Bzr](http://stompbox.typepad.com/blog/images/2008/10/13/bzr.png)](http://stompbox.typepad.com/photos/uncategorized/2008/10/13/bzr.png)

There will be a follow up article next month as well. Special thanks to
Robert Collins for helping to answer Rick’s questions about bzr.
