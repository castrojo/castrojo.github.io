...
Now that the Ubuntu font is [available via the Google Font
thing](http://googlewebfonts.blogspot.com/2010/12/introducing-ubuntu-font-family-to-web.html) I
took a few minutes to add it to my blog.

Here are [the
instructions](http://code.google.com/webfonts/family?family=Ubuntu&subset=latin#code),
it’s just a few lines of HTML. You can find more information about using
the font on the web [here](http://font.ubuntu.com/web/).
