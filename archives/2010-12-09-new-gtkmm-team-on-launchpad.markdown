...
Thanks to the tireless efforts of Krzysztof Klimonda we now have a team
in Launchpad for [gtkmm](http://www.gtkmm.org/en/) folks.

[\[https://launchpad.net/\~gnomemm\](https://launchpad.net/\~gnomemm)](https://launchpad.net/~gnomemm)

If you’re interested in helping maintain the gtkmm stack in Ubuntu then
please join this team. We could really use a hand as keeping finding
people to help with this stack on a regular basis has been a problem for
us. 

While setting up the team Krzysztof also updated atkmm and gtkmm in
Natty to the latest versions so you’ve got that to play with!
