...
Francesco Banconi has just announced [Juju Quickstart
1.60](https://jujugui.wordpress.com/2015/01/14/juju-quickstart-1-6-0/).

Too many improvements to list here, so just check out his blog post,
available in `ppa:juju/stable` and Homebrew for your OSX users.
