...
I’m looking for instructors for Ubuntu Open Week, which is traditionally
held on the week after release on \#ubuntu-classroom on Freenode. Want
to teach a course on something? Here’s a great way to jump in and help
out.

[![Ubuntu Open
Week](http://i.stack.imgur.com/20zAI.png)](https://wiki.ubuntu.com/UbuntuOpenWeek)

([Original
Post](https://lists.ubuntu.com/archives/ubuntu-devel/2011-September/034057.html))
(Logo by htorque)
