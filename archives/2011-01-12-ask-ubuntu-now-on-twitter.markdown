...
However it’s not just a fancy RSS feed.
[@StackUbuntu](http://twitter.com/#!/stackubuntu) publishes questions
based on
[interestingness](http://blog.stackoverflow.com/2011/01/twitter-question-feeds-for-stack-exchange/) so
you’re not flooded with too much.

![](http://media.tumblr.com/tumblr_lex9inmZHV1qb5bmy.png)
