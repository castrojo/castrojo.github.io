...
Just a reminder that if you listen to Pandora that pianobar is a great
little CLI client for that, especially if you are sshing to a machine
with larger speakers than say your laptop.

![](http://www.jorgecastro.org/images/pianobar.png)

[![Install via the software
center](http://hostmar.co/software-banner)](https://apps.ubuntu.com/cat/applications/pianobar)

If you’re looking for a GTK client check out Pithos:

![](http://www.jorgecastro.org/images/pithos.png)

[![Install via the software
center](http://hostmar.co/software-banner)](https://apps.ubuntu.com/cat/applications/pithos)
