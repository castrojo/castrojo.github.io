...
I am finding that [Droidstack](http://code.google.com/p/droidstack/) is
a pretty great way to participate on the [Ubuntu Stack
Exchange](http://ubuntu.stackexchange.com/) and all the others if you’re
on Android.
