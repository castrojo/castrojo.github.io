...
MAAS [is ready](http://www.markshuttleworth.com/archives/1103) for
people to start banging on. If you’ve been struggling with Orchestra
deployments then consider this the new version of that, and as you can
see from the instructions, it’s already way easier. Here’s the
instructions to get it started, and how to point juju to your MAAS
installation so you can start deploying services.
