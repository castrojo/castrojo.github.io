...
Rick Harding has [pushed
out](http://mitechie.com/index.php?/archives/291-Finally,-some-time-after-this-weekend-to-work-on-cool-stuff.html)
some new PPA builds of [GNOME Do](http://do.davebsd.com/) today.

Dave put out a [call for
documentation](http://groups.google.com/group/gnome-do/browse_thread/thread/245d8dd2d9fa54de)
and holy smokes did people deliver. A big note of thanks goes to
[blutack](https://edge.launchpad.net/~blutack), who totally just rocked
the [docs](https://wiki.ubuntu.com/GnomeDo) this week. Thanks!
