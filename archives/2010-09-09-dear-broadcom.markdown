...
[Thank you](http://lwn.net/Articles/404248/), and welcome!

EDIT: I’ve [asked if the
driver](http://ubuntu.stackexchange.com/questions/3929/will-the-new-open-source-broadcom-drivers-be-available-in-the-current-lts-release/3930#3930) might
be coming to Lucid and got a response from someone on the kernel team,
