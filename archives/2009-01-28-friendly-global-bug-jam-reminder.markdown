...
Just two quick reminders for those of you who are participating in the
[Ubuntu Global Bug Jam](https://wiki.ubuntu.com/GlobalBugJam). First of,
please remember to add your Local team to the list! This is to help
people find teams in their area, so please get your information up
there, even if it’s TBD, and fill it out later.

Also, this Friday Daniel and I will be hosting “How to Run a Bug Jam”
sessions in IRC on \#ubuntu-classroom - so if you want to be involved
and need help, drop on by. All the scheduling information is
[here](https://wiki.ubuntu.com/GlobalBugJam).
