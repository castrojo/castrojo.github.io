...
For 11.10 the launcher team worked on a new alt-tab. Here’s how I use it
to switch between not only applications, but windows within
applications.

(Sorry about the flicker, seems to be a result of recording it)

\[youtube
http://www.youtube.com/watch?v=XHFNnygpvcM?hd=1&w;=480&h;=390\]
