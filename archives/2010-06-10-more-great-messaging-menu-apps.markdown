...
\*\*![](http://24.media.tumblr.com/tumblr_l3tc6p098W1qbszrto1_400.png)\
\*\*

Ken Van Dine has packaged up Matt
Mossholder’s [gvoice-notifier](http://launchpad.net/gvoice-notifier) in
a PPA. I’ve added the PPA to the list of [messaging menu
applications](https://wiki.ubuntu.com/MessagingMenu/Applications). If
you want to help package these up and get them rocking then feel free to
grab one! We’re always looking for great applications!

(If you just thought, “Oh neat, if I could SMS from the me menu like you
can with the chrome extension…” then congrats on the great idea,
here’s [the
bug](https://bugs.launchpad.net/gvoice-notifier/+bug/592386)!)
