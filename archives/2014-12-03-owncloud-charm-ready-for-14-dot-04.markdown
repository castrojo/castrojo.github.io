...
Matt Bruzek and Jose Antonio Rey have now updated the tests and charm
for [Owncloud](http://www.owncloud.org) for 14.04, you can find it here
at the snazzy new jujucharms.com.

-   <https://jujucharms.com/trusty/owncloud>

Note that this does use upstream’s packages and you can set the version
of Owncloud in the charm itself, so it doesn’t go out of date!
