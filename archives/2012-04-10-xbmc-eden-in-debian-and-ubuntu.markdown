...
The hero of today for me is Andres Mejia, who has put [XBMC Eden into
Debian](http://xbmc.org/theuni/2012/04/10/xbmc-accepted-into-debian/)
and it’s been synced into Ubuntu for 12.04. Thanks to everyone involved
who made that happen, Eden has been really great for me.

In other XBMC News, I am finding that [turning on dirty
regions](http://wiki.xbmc.org/index.php?title=Dirty_regions) has
improved my UI performance quite a bit, though from asking around it
seems to be hit and miss with some people.
