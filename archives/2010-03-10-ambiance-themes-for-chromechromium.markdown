...
Found these if you’re looking for a Chrome/Chromium theme to match
Lucid:

-   [Theme](https://chrome.google.com/extensions/detail/elnmibmpefhmfgphdphdncoogpbfmlbp)

-   [Scrollbar](https://chrome.google.com/extensions/detail/mikdfeaeaecoffpjoodiihgejnbfigln)

I had to turn on the system titlebars to make it fit the desktop which I
have to get used to since I have grown accustomed to the melded
tab/titlebar. Enjoy, and thanks to tobiash for making these!
