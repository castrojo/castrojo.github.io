...
David Calle has been working on a Books Lens, which lets you search for
free books on the internet. The workflow is like this. Super, “Dune”,
enter, start reading Dune in Google Books. Neat huh?

Well wouldn’t it be cool if a lens knew what you were looking for before
you even start typing?

([Video
Link](http://www.youtube.com/watch?v=SRM0z9GprQg&feature=player_embedded#at=15))

\[youtube http://www.youtube.com/watch?v=SRM0z9GprQg?rel=0\]

The zeitgeist integration isn’t ready yet, but David’s working on it. In
the meantime enjoy the current lens and all the books it finds, here’s
[the PPA](https://launchpad.net/~davidc3/+archive/books-lens).
