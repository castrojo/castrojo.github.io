...
Joe “Zonker” Brockmeier did a [quick podcast
interview](http://www.linux-mag.com/id/4640/) with Jono about all sorts
of things for [Linux Magazine](http://www.linux-mag.com/), like PPAs and
where Ubuntu is headed in the future.

Since it’s the end of the year Joe wanted to ask what people think will
happen in 2008. For my part, I predict that Ubuntu will release 2
(that’s right, TWO) new versions of Ubuntu in 2008. What are your
predictions for open source and Ubuntu? Post below or blog about it.
