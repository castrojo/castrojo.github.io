...
Thanks to a rockstar team of Ubuntu developers, generally speaking I
don’t have to care about systemd as whole. I do have to care about the
user exposed surfaces though. Here’s a good way to get started:

-   <https://wiki.ubuntu.com/SystemdForUpstartUsers>

Thanks to whoever put this together, this is a brilliant way to get
people up to speed.
