...
This morning at the [OpenStack Developer
Summit](http://www.openstack.org) Mark Shuttleworth demoed the new Juju
web interface:

![](http://www.jorgecastro.org/images/jujugui.png){.middle}

While the juju command line is great for building your own deployment,
...
You can find the code to the Juju GUI at:

-   <http://launchpad.net/juju-gui>

and we have a demo running at <http://uistage.jujucharms.com:8080> which
resets every 15 minutes, and you’re not actually deploying anything, but
it’ll give you an idea on how it works. You can find us on \#juju-gui on
Freenode.

Though we’re pretty proud of what we’ve built so far we’re looking
forward to people playing with and improve the UI. Happy Hacking!
