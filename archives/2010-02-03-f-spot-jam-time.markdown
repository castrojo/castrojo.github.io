...
[![](http://castrojo.files.wordpress.com/2010/02/paperjam1.jpg?w=300)](http://castrojo.files.wordpress.com/2010/02/paperjam1.jpg)

Round 7 of 100 papercuts is ready to go, with this set concentrating on
the default photo editor,
[F-Spot](https://bugs.edge.launchpad.net/hundredpapercuts/+milestone/lucid-round-7).
If you’re interested, grab a bug and rock it.
