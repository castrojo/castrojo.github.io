...
Surprised this isn’t all over Planet so here goes: the Netscape/Mozilla
documentary Code Rush is now
[available](http://creativecommons.org/weblog/entry/16579) under the
Creative Commons. In short it’s about the birth of Mozilla (and kind of
the death of Netscape, though that’s hind sight). Anyway it’s an older
documentary and was one of the very first things that really got me
interested in OSS, so you should check it out if you’ve never seen it
before.
