...
So I’ve always thought that someone should take
[terminator](https://launchpad.net/terminator) and put it together with
[hotssh](http://projects.gnome.org/hotssh/). What I didn’t realize until
now is the awesome name of this hypothetical terminal of doom.

![ssherminator](http://castrojo.files.wordpress.com/2008/12/pie2.jpg)
