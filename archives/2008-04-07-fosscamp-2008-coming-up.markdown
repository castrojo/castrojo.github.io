...
![Logo](http://stompbox.typepad.com/photos/uncategorized/2008/04/07/logo.jpg)

The [list of attendees](http://fosscamp.org/HowToAttend) for
[FOSSCamp](http://www.fosscamp.org) continues to grow. Recently added
are people from Tango, Netbeans, Inkscape, openSUSE, Fedora, Ubuntu,
glom, gtkmm, [Campware.org](http://www.campware.org/), [Media
Development Loan Fund](http://www.mdlf.org/), and of course, more GNOME
and KDE folks.

FOSSCamp will be taking place 16 and 17 May in Prague, Czech Republic
and is open to all at no cost, so if you’re project is not represented,
then please consider coming!
