...
Just a reminder that the sponsorship application deadline is 8th
September if you haven’t already applied! For more information please
see this page: <http://uds.ubuntu.com/participate/sponsorship/>

(There is a bug in the summit system that is telling people that the
deadline is March 26, this is incorrect!)
