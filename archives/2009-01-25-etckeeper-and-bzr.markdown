...
etckeeper is a great little tool for keeping your /etc in revision
control so if you fat finger something you’re only a revert away from
your known state. It’s now using [bzr by
default](https://bugs.edge.launchpad.net/ubuntu/+source/etckeeper/+bug/191680)
in Ubuntu.
