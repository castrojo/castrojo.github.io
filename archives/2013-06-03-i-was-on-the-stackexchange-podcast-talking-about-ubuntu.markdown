...
Last month the folks at [StackExchange](http://stackexchange.com)
approached me about appearing on their podcast. I was flattered to be
involved. We talk about the community teams at Canonical and
StackExchange, Ubuntu Brainstorm, and how [Ask
Ubuntu](http://askubuntu.com) works and things we can work on to make it
better.

Check it out here:

-   [Podcast \#48 – Sponsored by Powdermilk
    Biscuits](http://blog.stackoverflow.com/2013/06/podcast-48-sponsored-by-powdermilk-biscuits/)

or you can check it out [on Soundcloud
directly](https://soundcloud.com/stack-exchange/stack-exchange-podcast-48).
