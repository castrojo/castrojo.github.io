...
Just a quick post that Canonical is moving some server next weekend (on
18 August) and this will affect a bunch of sites, notably the forums,
lists and wikis. The full list is available from the mailing list post:

-   [Community site downtime
    announcement](https://lists.ubuntu.com/archives/loco-contacts/2012-August/005922.html)

The archive, CD downloads, SSO and Ubuntu One will not be affected.
