...
Jay Taoko has put up a blog post talking about [Unity’s hardware
requirements](http://www.inalogic.com/component/content/article/34-general/63-demystifying-unitys-graphics-hardware-requirements).
You can find the information on the [wiki
page](https://wiki.ubuntu.com/DemystifyingUnityGraphicsHardwareRequirements)
too.

On the wiki page we talk about the OpenGL features we use and the
hardware we test on, we hope to grow this over time. 
