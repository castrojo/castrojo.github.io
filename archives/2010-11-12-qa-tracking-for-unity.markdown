...
Thanks to the hard work of Brian Murray we now have a section for Unity
on
[\[http://status.qa.ubuntu.com\](http://status.qa.ubuntu.com)](http://status.qa.ubuntu.com)

![](http://media.tumblr.com/tumblr_lbsdxbTQII1qb5bmy.png)

And here it is for the package level:

![](http://media.tumblr.com/tumblr_lbsdy1gFI71qb5bmy.png)
