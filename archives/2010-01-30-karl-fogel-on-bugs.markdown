...
Karl Fogel works on Launchpad’s Bugs team. He’s also famous for a bunch
of [other stuff](http://www.red-bean.com/kfogel/). Since he’s not
syndicated on Planet Ubuntu I would like to point out his post on [bugs
and tech
debt](http://www.rants.org/2010/01/10/bugs-users-and-tech-debt/), which
is a useful read for everyone!
