...
Now that the parties are out of the way (pics later), we can relax
right? Wrong! The Ubuntu train never stops, there will be no rest for
the wicked. Just a quick reminder that
[OpenWeek](https://wiki.ubuntu.com/UbuntuOpenWeek/) starts this Monday
at 1500UTC.

OpenWeek is a weeklong set of IRC sessions designed to grow the Ubuntu
community.

![Ubuntuopenweeksmall](http://stompbox.typepad.com/photos/uncategorized/2008/04/27/ubuntuopenweeksmall.png)

The timing is particularly good this time, we’re at the very beginning
of the cycle for Ibex (not even a UDS yet!) - so now is a good
opportunity for you to get involved if you want to learn about
packaging, filing bugs, running upstream kernels, and the entire bunch
of workshops we’ve [got
planned](https://wiki.ubuntu.com/UbuntuOpenWeek/) for you. See you
there!
