...
<http://whoisi.com/e/uds-jaunty> {#httpwhoisicomeuds-jauntyhttpwhoisicomeuds-jaunty}
--------------------------------

This URL is a conglomeration of information around the Ubuntu Developer
Summit, both serious work related stuff and the lighter side. Feedback
requested.
