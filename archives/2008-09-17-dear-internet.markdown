...
It is entirely possible to *constructively* criticize actions of an
upstream project without resorting to name calling, ALL CAPS, whining,
threats, personal attacks, and other juvenile behavior.

I’m pretty sure I’ve [read this
before](http://www.ubuntu.com/community/conduct) somewhere…
