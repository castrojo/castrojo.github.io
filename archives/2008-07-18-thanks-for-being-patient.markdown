...
I now have access to approve/disapprove LoCo mailing list requests and
have cleared most of the queue of requests, so if you’ve been waiting
for a list then sorry for the delays.
