...
Looks like I was lucky and able to create a community page for Ubuntu on
Google plus:

-   [Ubuntu Community on
    G+](https://plus.google.com/u/0/communities/107299007624972266094)

No idea how this will relate to the existing Ubuntu social accounts but
since I had the option to create one I figured I would stake our claim.
