...
Chris Coulson has been working on adding [Application
Menu](https://wiki.ubuntu.com/DesktopExperienceTeam/ApplicationMenu) support
to Firefox for 11.04. Here’s the initial cut:

[![](http://media.tumblr.com/tumblr_lda6zz5e2m1qb5bmy.png)](http://people.canonical.com/~chrisccoulson/Screenshot.png)

The reason you still see the old menu inside the window is that for
testing developers will have both running so they can compare them side
to side.

You can find the code to the extension
here: [\[https://launchpad.net/globalmenu-extension\](https://launchpad.net/globalmenu-extension)](https://launchpad.net/globalmenu-extension)

Hackers and testers are welcome, but please remember that this is very
young, so don’t expect ponies and unicorns. 
