...
Chris Jones sends along that the terminator
[team](https://edge.launchpad.net/%7Egnome-terminator) has started
uploading [Terminator 0.9
Betas](http://www.tenshu.net/archives/2008/06/19/terminator-09-betas/)
into their team PPA.

[Terminator](https://edge.launchpad.net/terminator), in case you don’t
know, let’s you put many terminals in one window. It’s full of sysadminy
goodness.
