...
Today [we
announced](https://insights.ubuntu.com/2014/07/16/canonical-welcomes-brightbox-to-its-certified-public-cloud-programme-as-first-european-partner/)
that Brightbox has joined the Ubuntu Certified Cloud programme, and is
our first [European Cloud
Partner](http://brightbox.com/blog/2014/07/16/ubuntu-certified-cloud/).

If you’re wondering where have you heard the name Brightbox before, it
might be because they contribute [updated Ruby
packages](http://brightbox.com/docs/ruby/ubuntu/) for all Ubuntu users.

Official images that stay up to day, updated Ruby stacks for developers,
it’s pretty much win-win for Ubuntu users!
