...
[From
idea](http://castrojo.tumblr.com/post/2628441518/integrating-with-web-apps) to
…. [now
available](https://chrome.google.com/webstore/detail/nmgdlkljbfeeinemfljcbmnkmbeligmn).

Many thanks to Stuart Langridge for his initial prototype and to George
Edison and Marco Ceppi for implementing it and submitting it through the
web store process. 
