...
Just a warning that the chrome-ubuntu-theme scrollbar extension has been
causing crashes for people. Mike Basinger reported [the bug
here](https://code.google.com/p/chrome-ubuntu-themes/issues/detail?id=1#c1)
but it appears to be triggering a webkit bug.
