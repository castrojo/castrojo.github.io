...
Ok, I tried to be patient but this is getting silly, I’m moving to
[friendfeed](http://friendfeed.com/jcastro) instead of using twitter.

EDIT: Don’t forget to join the [Ubuntu
room](http://friendfeed.com/rooms/ubuntu-linux)!
