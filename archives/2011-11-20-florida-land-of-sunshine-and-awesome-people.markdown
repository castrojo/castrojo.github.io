...
Ok so I started making a list of people to thank but it started to get
long and then I realized that if I missed someone it would be even
worse, so I am sticking to one person:

**Chris Johnston**

![](http://media.tumblr.com/tumblr_lv0qvn7oz51qb5bmy.jpg)

He works on summit.ubuntu.com, the loco directory, and
status.ubuntu.com. He’s basically an infrastructure ninja.
