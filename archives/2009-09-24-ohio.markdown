...
I will see you all tomorrow and Saturday at THE [Ohio
Linuxfest](http://www.ohiolinux.org/). I’ll be floating around tomorrow,
probably spending time in the
[Hackathon](http://www.ohiolinux.org/hackathon.html) area with other
ubu-maniacs. If you’re around consider dropping by, I am keen on having
an impromptu bug jam or if you need some Ubuntu tips or something.
