...
While I didn’t have time to attend Scott James Remnant’s multi-hour
FOSSCamp session on how the Linux boot process works I did run into some
[notes](https://wiki.ubuntu.com/MeetingLogs/devweek0901/BootPerform)
from Developer Week and [a
spec](https://wiki.ubuntu.com/FoundationsTeam/Specs/BootPerformance) on
the work. There is also the
[ubuntu-boot](https://lists.launchpad.net/ubuntu-boot/) mailing list
with more information on what’s going on.
