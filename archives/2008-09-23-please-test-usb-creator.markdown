...
Aside from being a ninja, Evan Dandrea also works on Ubuntu installer
stuff. You know all those ISOs you have laying around from ISO testing?
You can use those to test the usb-creator. Evan has posted his request
to the list, but it’s not in the archives yet, so I posted it to [forum
thread](http://ubuntuforums.org/showthread.php?p=5841522#post5841522).
