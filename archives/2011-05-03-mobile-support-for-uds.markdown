...
Thanks to the tireless work of David Mandala, we’ve got some pretty nice
mobile integration this UDS with
[Guidebook](http://www.guidebookapp.com/).

![](http://media.tumblr.com/tumblr_lkn0dvB7Ml1qb5bmy.jpg)![](http://media.tumblr.com/tumblr_lkn0frgA4G1qb5bmy.jpg)

Not only do you have the schedule, but there’s a MAP of the venue right
in the application as well and even the list of after hour social
events.

Thanks also to Michael Hall for integrating support into Summit, which
gives us a nice rememberable URL for your friends:
[\[http://summit.ubuntu.com/mobile\](http://summit.ubuntu.com/mobile)](http://summit.ubuntu.com/mobile) and
QR codes on the schedule itself.
