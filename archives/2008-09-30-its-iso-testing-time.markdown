...
Friends, Romans, countrymen! Lend me your vm’s, desktops, and hardware
that is laying around. I have come to test the Intrepid ISO, not to
praise it (yet)! The bugs that releases do lives after them, the good is
oft interred with their bones. The noble sabdfl has told you that
Intrepid is ambitious ….

Ok, enough bad poetry. Now is the time to help test the Intrepid ISOs -
The also noble Henrik has put [a call to
test](https://lists.ubuntu.com/archives/ubuntu-devel/2008-September/026620.html)
the beta ISOs. Instructions included in the post. People with 64 bit and
DVDs are really needed.
