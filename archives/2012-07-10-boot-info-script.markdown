...
Ever need to help someone with their boot?

There’s a great tool in the archive called
[boot-info-script](https://apps.ubuntu.com/cat/applications/boot-info-script)
[![Install
boot-info-script](http://hostmar.co/software-small)](https://apps.ubuntu.com/cat/applications/boot-info-script)

A person can install this and run `sudo boot_info_script` and then send
it along to you or pastebin it. Quick and easy!
