...
UPDATE: I’ve moved this to Ask Ubuntu so it can get updated over time.

Well, we’re a week away from 11.04 so I decided that I would collate the
information about Unity on the web and put it into one nice page for
everyone to find. Got some more tips you’d like to add? Add them in the
to the answer!

[Tips and Tricks for Unity](http://askubuntu.com/q/36274/235)
