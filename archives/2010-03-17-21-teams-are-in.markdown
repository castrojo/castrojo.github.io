...
[![](http://castrojo.files.wordpress.com/2010/03/ugj09_button_orange_250x148_en.png)](http://castrojo.files.wordpress.com/2010/03/ugj09_button_orange_250x148_en.png)

As of right now 21 Local teams have committed to the [Global
Jam](https://wiki.ubuntu.com/UbuntuGlobalJam) next weekend. Check out
the [event page](http://loco.ubuntu.com/events/) on the LoCo directory
to sign up your team! Surely we can bring in more teams. You can try
some positive motivation, or some competitive motivation, like so:
“Where are you Ohio? It’s on. Michigan is once again on top.” Let’s see
what paultag has to say about that!

As always, we’re idling in \#ubuntu-locoteams on freenode if you need
help planning the last minute details.
