...
The Yorba folks have released a [new version of
Shotwell](http://www.yorba.org/blog/jim/2010/12/shotwell-080-and-gexiv2-022-released.html).
You can [snag it here](http://www.yorba.org/shotwell/).

New features include:

-   Video support for Ogg, AVI, MP4, Quicktime, and WMV files

-   Upload videos to major Web services, including YouTube, Facebook,
