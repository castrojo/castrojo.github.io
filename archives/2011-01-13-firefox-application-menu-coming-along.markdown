...
Chris Coulson has the Firefox application menu extension working and in
PPA for Natty testers:

[Instructions here](http://askubuntu.com/q/21373/235).

Please note, this is fast moving, so if your going to blog or retweet it
please link to those instructions as I will be updating it over the
course of the next few weeks.

![](http://media.tumblr.com/tumblr_leyyy9CWhm1qb5bmy.png)
