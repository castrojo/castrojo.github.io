...
The Juju GUI team has landed another release, this debuts the new
inspector, which shows you information about a specific service. In this
example we’re checking out what’s going with these 11 units of
mediawiki:

![](http://www.jorgecastro.org/images/inspectorblogshot.png)

Play around in the [mock environment](https://jujucharms.com/sidebar/)
or [fire up your
own](https://jujucharms.com/precise/juju-gui-76/#bws-readme). Build
something amazing and enter it in the [Charm
Championship](https://juju.ubuntu.com/charm-championship/) for a chance
to win \$10k!
