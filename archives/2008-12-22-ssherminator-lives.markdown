...
up ssherminator, which I mentioned in [this blog
post](http://castrojo.wordpress.com/2008/12/20/oh-man/). Terminator and
hotssh coming together. You can snag the tarball
[here](https://edge.launchpad.net/ssherminator/trunk/0.1.0-terminator617)
and the code [here](https://code.edge.launchpad.net/ssherminator). Feel
free to branch and hack on it and give David feedback. UI help would be
especially welcome!

I told you all it was about the people, this kind of proves it, heh. :-D
