...
Aha [clever
Jamie](http://penguindroppings.wordpress.com/2011/04/08/unity-and-me/),
he put two and two together so he can add SSH shortcuts to quicklists.
Here’s my setup to the three machines at home:

![](http://media.tumblr.com/tumblr_ljiezcNTcU1qb5bmy.png)
...
Though maybe I should assign the one I ssh to the most under the first
Exec and save some space. Of course, if this was a dynamic quicklist
that just autopopulated the list based on what avahi says is around that
would be slick.
