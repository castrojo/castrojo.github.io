...
Andre Klapper would like to pass along his highly detailed infographic
for bug triagers on where the URL field is in GNOME Bugzilla. Ubuntu
GNOME bug triagers, take note!

![dajorge](http://castrojo.files.wordpress.com/2009/08/dajorge.png)
