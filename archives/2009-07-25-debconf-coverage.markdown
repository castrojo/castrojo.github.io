...
mdz, myself and others are denting about Debconf, follow along
[here](http://identi.ca/tag/debconf).

Right now the Debian Project Leader is speaking, tune in using the
realtime [streams](http://wiki.debconf.org/wiki/DebConf9/Streams).

EDIT: Oops, the official tag is \#debconf9 and \#dc9, so [heads
up](http://identi.ca/tag/dc9).
