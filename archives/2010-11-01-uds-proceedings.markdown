...
Here’s a bunch of summaries from the [UDS
Proceedings](https://wiki.ubuntu.com/UDSProceedings/N/). Sorry they’re
not more organized.

UPDATE: As many of you have pointed out, these are raw and in some cases
don’t even make sense since they’re pasted in from people furiously
typing into gobby documents. They’ll be polished as the week progresses.
