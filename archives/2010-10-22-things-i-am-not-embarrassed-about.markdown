...
When copying files around with rsync I always use the  flags -avp.

I actually find myself muttering “aliens vs. predator” every time I type
it. Am I weird? It seems like a good way to remember flags to me.

EDIT: Ah, it seems -a implies -p, but that’s not the way I originally
rememberized it. It guess that’s like years of extra p’s in my life.
