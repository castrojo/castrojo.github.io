...
It can be difficult to find the right AMIs on AWS sometimes. Scott Moser
[has some tips](http://askubuntu.com/q/53582/235) on how you can always
find the right AMI’s for Ubuntu, but that might not be obvious to some
people.

We’ve started linking directly to the
[cloud-images](http://cloud-images.ubuntu.com/releases/) directory right
from cloud.ubuntu.com, but I am interested if people prefer the [AMI
browser](http://cloud.ubuntu.com/ami/), Amazon’s built in thing, or
Alestic or whatever. Leave a comment!
