...
I have just
[announced](https://lists.ubuntu.com/archives/ubuntu-bugsquad/2009-February/001292.html)
the first cut of Graham Binns’ upstream-task-opening tool. This should
be useful for triagers and package maintainers. I plan to use it during
the [Global Bug Jam](https://wiki.ubuntu.com/GlobalBugJam). Please leave
feedback in the thread or drop me a mail.
