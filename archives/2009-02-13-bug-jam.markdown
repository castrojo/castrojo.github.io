...
Reminder: Tonight at midnight UTC (aka. 7pm EST) I will be giving a
tutorial how to run a Bug Jam on freenode IRC, \#ubuntu-classroom. I
encourage LoCo people to attend to get a better idea on how to run a
more efficient [Global Bug Jam](https://wiki.ubuntu.com/GlobalBugJam).
