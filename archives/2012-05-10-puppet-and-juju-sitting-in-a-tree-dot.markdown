...
This will be a short post because I’m at UDS; but in the Juju
integration session Clint Byrum started to talk about his subordinate
Puppet Charm.

Here’s how you can deploy a
[puppetmaster](http://jujucharms.com/charms/precise/puppetmaster) in the
cloud, and then here’s the [subordinate puppet
charm](http://jujucharms.com/charms/precise/puppet). The subordinate
charm supports pointing to your existing puppetmaster or an external one

We think this is an awesome combination of two tools, you can just plop
puppet subordinates on deployed services to do what you want to do with
puppet, and then use juju to orchestrate the deployment. More
information to follow, in the meantime feel free to play with it!
