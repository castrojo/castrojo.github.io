...
If this comments like the ones left in [this
story](http://blogs.computerworld.com/15443/talling_firefox_3_6_one_more_reason_linux_isnt_ready_for_the_prime_time_mass_market)
are indicative of how we’re going to present ourselves to users then we
should just get it over with and [treat them like
this](http://www.youtube.com/watch?v=Y_GJkKMPHxw).
