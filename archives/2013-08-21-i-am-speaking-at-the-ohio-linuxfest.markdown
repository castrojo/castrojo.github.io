...
I’ve been fortunate to be selected as a speaker for the Ohio LinuxFest
2013!

On Friday I will be participating in the
[UbuCon](http://www.ohiolinux.org/friday). There’s a ton of great talks
lined up, mine will be “How to Use Ask Ubuntu Effectively to Get Help”,
where I’ll be talking about some techniques on user support.

![](http://www.jorgecastro.org/images/ubuntu-ohio.jpg)

Then for the main show I’ll be giving “Service Orchestration in the
Cloud with Juju in Ubuntu” which takes place at [5pm on
Saturday](http://www.ohiolinux.org/saturday). I’ll be showing off some
of the advances we’ve made in getting your apps deployed on the cloud as
quickly and easily as possible.

And that’s not all for the Midwest. Make sure you catch Jono Bacon’s
“Building a Convergent Future with Ubuntu”, which is also on [Saturday
at 10am](http://www.ohiolinux.org/saturday).
