...
Ahmed and I have tagged some Ensemble formula requests as
[bitesize](https://bugs.launchpad.net/principia/+bugs?field.tag=bitesize).
The PHP ones will be pretty straight forward, so if you’re deploying in
EC2 and want to dive in and share your expertise (and snag some existing
formulas for yourself!)

If you’re looking for a Formula for something you’d like to see to be
made easy to deploy in EC2 please feel free to file a new bug.

You can find the docs for writing formulas
[here](https://ensemble.ubuntu.com/Principia). If you’re writing an
awesome app you’d like to see made easy to deploy in EC2, then let me
know and we’ll get started.
