...
I have so many people to thank this time around I’m just going to post
them all throughout the next few days. The first is Merlijn Sebrechts,
one of the new breed of big data experts collaborating around [Big
Data](http://bigdata.juju.solutions/).

Merlijn is bringing the [Tengu
Platform](http://tengu.intec.ugent.be/v1/) to users, which is a platform
for big data experimentation, you can find [more about it
here](http://tengu.intec.ugent.be/v1/?page_id=53).

You can find Merlijn’s work
[here](https://github.com/galgalesh/tengu-charms).

![](http://www.jorgecastro.org/images/summit.jpg){.center}
