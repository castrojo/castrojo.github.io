...
[![](http://lh4.ggpht.com/_1Thkya8n93k/TBJZnVOIacI/AAAAAAAAaRg/k0986KuuHiE/s400/unity.png)](http://picasaweb.google.com/lh/photo/5ZBxA1b1oPhzVE9QIwJ61S-l3z-BjM6dLNoML06aFOU?feat=embedwebsite)

Just a reminder that the new interface for the Ubuntu Netbook Edition
released .2 yesterday, and we’re looking for more testing and feedback!
Here are [the
instructions](https://wiki.ubuntu.com/DesktopTeam/Unity) with the PPA
you need for Lucid (it’s in Maverick too).

Remember to [file bugs](http://launchpad.net/unity) as you see em!
