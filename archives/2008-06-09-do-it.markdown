...
GNOME Do .5 “The Fighting .5” [now
out](http://blog.davebsd.com/?p=65&preview=true). There’s been so much
work done in this release that I can’t even mention it all, so just go
check it out. Also, Dave is looking for donations for maintenance of the
domain and hosting for plugins, etc., so if dig Do and want to send him
a few bucks we’d appreciate it!

RAOF is working on the PPA builds as we speak … so stay tuned!
