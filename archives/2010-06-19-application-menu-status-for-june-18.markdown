...
Just in case you missed it, since I’m posting on ayatana-dev now, here
is the [latest status
report](https://lists.launchpad.net/ayatana-dev/msg00004.html) for
progress on the [application
menu](https://wiki.ubuntu.com/DesktopExperienceTeam/ApplicationMenu) for
UNE 10.10. 
