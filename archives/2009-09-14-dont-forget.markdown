...
Ubuntu Local teams, if you’re participating in the [Ubuntu Global
Jam](http://wiki.ubuntu.com/UbuntuGlobalJam/) please don’t forget to add
your team to the [participation
list](https://wiki.ubuntu.com/UbuntuGlobalJam/Events)!
