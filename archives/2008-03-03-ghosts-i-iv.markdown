...
I love NIN so I was happy to see the announcement about their new
[album](http://ghosts.nin.com/main/home). Their website has been slammed
so I wasn’t able to purchase it directly from them, so I just bought it
from Amazon using their new [downloader for
Linux](http://www.amazon.com/gp/dmusic/help/amd.html).

I hope Trent follows up in the future and blogs about how the album did
sales-wise. It will be interesting to see how many people supported the
band and how many just downloaded the free album.
