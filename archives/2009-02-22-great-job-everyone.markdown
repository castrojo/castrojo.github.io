...
It’s been a great weekend watching people post their [Global Bug Jam
Stories](http://wiki.ubuntu.com/GlobalBugJam/Stories) and watching the
activity buzz all over Launchpad.

I’d like to do a special shout out to the LoCo from [Rochester, New
York](https://wiki.ubuntu.com/NewYorkTeam/Events/20090221). I met some
of these guys at the [Ontario Linuxfest](http://onlinux.ca) (which btw,
just opened their call for papers). I am glad to see that Rochester was
so strongly represented, perhaps we should do another bug jam in
Ontario?

And just in case you missed it, let me reiterate that LoCos can have as
many Jams as much as they want, so if your Jam was a huge success, feel
free to do more!
