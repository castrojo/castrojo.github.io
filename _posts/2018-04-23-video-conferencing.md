...
- Get a Microphone - Other than my desk, chair, and good monitors, this is the number one upgrade you can do. Sound is one of those things that can immediately change the quality of your call. I use a [Blue Yeti](https://www.bluedesigns.com/products/yeti/) due to the simplicity of using USB audio, and having a hardware mute button. This way I know _for sure_ I am muted when there's a blinking red light in my face. Learn to use your microphone. On my Yeti you speak across the microphone and it has settings for where to pick up the noise from. Adjust these so it sounds correct. Get a [pop filter](https://en.wikipedia.org/wiki/Pop_filter).
