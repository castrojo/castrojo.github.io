...
I’ve posted a screencast on how to use the [Ubuntu Stack
Exchange](http://ubuntu.stackexchange.com). ([Ogg
version](http://blip.tv/file/get/Ubuntudevelopers-HowToUseTheUbuntuStackExchange659.ogv))
