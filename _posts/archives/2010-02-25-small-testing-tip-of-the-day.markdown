...
Yesterday my gwibber crashed (for the first time in like 2 weeks!).
Unfortunately apport didn’t fire off so I got confused. I know the
.crash files end up in /var/crash so I found them in there and struggled
to remember the CLI command to sent off the crash files to launchpad.

Thanks to seb128 I now know that if you double-click on the .crash file
in Nautilus it will do the right thing and send off the crash report.
Neat and easy!
