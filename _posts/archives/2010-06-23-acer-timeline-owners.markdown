...
I’ve been mulling moving to a smaller form-factor laptop, something more
netbook-y. I’ve been eyeballing the [Aspire Timeline
1830T](http://www.engadget.com/2010/06/22/acer-aspire-timeline-x-laptops-arrive-stateside-sans-ulv-process/).

Does anyone with a current 1810T or 1810TZ care to comment on how it’s
running with Ubuntu? I found [this
thread](http://forum.notebookreview.com/acer/434638-linux-acer-1410-1810tz-1810t.html) on
a notebook forum, and the
[tips](https://help.ubuntu.com/community/Aspire1810TZ/Karmic) on the
help site look helpful. Any information on real-world battery
performance would be useful!

EDIT: Hey, looks like the 1830T has [hit the
States](http://www.engadget.com/2010/06/22/acer-aspire-timeline-x-laptops-arrive-stateside-sans-ulv-process/)!
