...
I’ve been pretty happy with the way Intel has supported their hardware
in linux over the past few years. Today’s release of
[documentation](http://intellinuxgraphics.org/) confirms that choice.

If only they made discreet cards. I know it’s in the works, but in the
meantime, a discreet PCI-E/AGP i965 card that can drive dual panels
would do the trick. :)
