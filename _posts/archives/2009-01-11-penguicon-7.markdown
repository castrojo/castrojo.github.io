...
Just a friendly reminder that you should register for [Penguicon
7](http://www.penguicon.org) and snag a hotel room asap.

Here’s the [hotel info](http://www.penguicon.org/hotel.php).

EDIT: Spelling. Yeesh, all this denting is doing bad things to my blog
entry quality.
