...
Here comes that important [number
5](http://digg.com/linux_unix/Make_a_real_difference_to_Ubuntu_with_5_A_Day).

EDIT: Pedro Villavicencio will be holding a bug triage session today on
IRC today for those of you who want to learn how to triage from one of
our best - check [the
schedule](https://wiki.ubuntu.com/UbuntuDeveloperWeek) for the time.

[Digg
It!](http://digg.com/linux_unix/Make_a_real_difference_to_Ubuntu_with_5_A_Day)
