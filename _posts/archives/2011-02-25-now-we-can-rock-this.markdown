...
Mikkel and Ken have a weekend present for you for those of you who have
been waiting to add Unity Launcher bling to your Python apps. I guess
these are bindings or “accessible in python” or whatever the GI way of
saying it is:

[\[http://wiki.ubuntu.com/Unity/LauncherAPI\](http://wiki.ubuntu.com/Unity/LauncherAPI)](https://wiki.ubuntu.com/Unity/LauncherAPI)

Please note that this is new and I’m really just trying to sucker you
into banging on it so you can file bugs and update documentation.
