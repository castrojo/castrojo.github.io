...
![](http://media.tumblr.com/tumblr_lji73teqtx1qb5bmy.png)

We’ve [sent out a
call](https://lists.ubuntu.com/archives/ubuntu-users/2011-April/242136.html) for
instructors for Ubuntu Open Week. Open Week runs from 2-6 May in
\#ubuntu-classroom (the week after release).

Since Developer Week is already off and rocking I’m looking for some
more end-user-y type sessions. Want to dig in? Then sign up and let me
know!
