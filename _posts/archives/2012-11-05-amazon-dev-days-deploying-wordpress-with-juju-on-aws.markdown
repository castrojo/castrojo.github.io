...
As part of our ongoing efforts to talk about service orchestration,
we’ve been doing a series of talks at conferences centered around the
problem that we’re trying to solve with Ubuntu Cloud and
[Juju](http://juju.ubuntu.com).

In this video Juan deploys Wordpress with all the goodies in just a few
commands:

This video is quite long and goes pretty deep into Juju, so I hope you
enjoy the depth!

Thanks to Amazon for sponsoring Dev Days!
