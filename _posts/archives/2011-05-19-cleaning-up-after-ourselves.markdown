...
At UDS I gave a lightning talk called “I’ve had enough and so have you,
a plea for sanity”, where I argue that misinformation on the internet is
harming the Ubuntu project and brand.

Here’s the video:

\[youtube http://www.youtube.com/watch?v=IT1yY78J9A0\]

([Direct Link](http://youtu.be/IT1yY78J9A0))

So, now that you’re motivated to clean up this mess, I’d like to clear
some things up. 

-   This isn’t a carte blanche to delete everything, be smart. You
    should probably not delete things that belong to other teams unless
    it’s way out of date.

-   We don’t have anywhere to place old Specs, and they are useful to
    keep around, so don’t mess with them. 

-   help.ubuntu.com isn’t the same as wiki.ubuntu.com, there’s a
    [separate
    workflow](https://lists.ubuntu.com/archives/ubuntu-doc/2011-May/015823.html) for
    tagging pages as deleteable material.

-   Even so, there are tons of crap you can just get rid of:

![](http://media.tumblr.com/tumblr_llgtyzeI4P1qb5bmy.png)
