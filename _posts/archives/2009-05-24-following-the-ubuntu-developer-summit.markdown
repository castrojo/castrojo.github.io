...
Find information about UDS [here](https://wiki.ubuntu.com/UDSKarmic).

You can follow along the buzz in realtime with our new
[lifestream](http://summit.ubuntu.com/media/lifestream.html) (no need to
hit reload!) or you can follow us directly on
[identi.ca](http://identi.ca/group/uds). Many thanks to the folks who
made the lifestream page (please leave a comment if you’ve contributed
to it!)

And of course, grab [the schedule](http://summit.ubuntu.com/uds-karmic/)
to follow along.
