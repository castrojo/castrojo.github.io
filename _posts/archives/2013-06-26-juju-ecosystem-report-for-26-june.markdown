...
-   [Video recording](http://youtu.be/2LpW8IxQwSI)
...
-   Public shaming time:
    ...
    -   Jorge only did one.
    -   Everyone else blew off the requirement and should be
        publicly flogged.
...
Goals from last week and this week. {#goals-from-last-week-and-this-week}
-----------------------------------
...
-   revision files no longer needed in charms, so if you see them, blow
    it away!
-   Mark to edit `charm proof` to not complain about revision
    file missing.
