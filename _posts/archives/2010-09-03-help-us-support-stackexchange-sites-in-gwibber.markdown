...
Now that the [OAuth
apocalypse](http://arstechnica.com/security/guides/2010/09/twitter-a-case-study-on-how-to-do-oauth-wrong.ars)
is over and my gwibber works again I had a thought of how to integrate
with more services. Wouldn’t it be neat if we stretched out to other
services, like say … the new [Ubuntu Stack
Exchange](http://ubuntu.stackexchange.com/) (I suck at GIMP, but you get
the idea):

![](http://media.tumblr.com/tumblr_l86vzeljD01qb5bmy.png)

Since we do multiple columns you could do your favorite tags, unanswered
questions, hot questions, whatever you like. Just like I do on my phone
with [Droidstack](http://code.google.com/p/droidstack/). You can just
add whichever SE network site you wanted!

I’ve already chatted with Ryan Paul about it and he’d be happy to review
a patch since him and Ken are busy with smashing bugs. If you’re
interested in this kind of feature please grab the bug and rock
it! [\[https://bugs.edge.launchpad.net/gwibber/+bug/629826\](https://bugs.edge.launchpad.net/gwibber/+bug/629826)](https://bugs.edge.launchpad.net/gwibber/+bug/629826)
