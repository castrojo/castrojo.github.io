...
As part of our effort to understand what our users need out of our tools
we now have a top-level survey at
[juju.ubuntu.com/survey](http://juju.ubuntu.com/survey).

This survey will always be up, so if you try Juju and have some feedback
for us feel free to fill it out. We’ll also be adding questions over
time as we [hit the road](http://juju.ubuntu.com/Events) talking about
Juju.

So if you’ve tried Juju and it does (or does not do) what you want, let
us know.
