...
Here’s the status for this week, as we continue to grind through patches
from contributors. 2 patches that need more work, 12 forwaded upstream,
2 to Debian, and one patch accepted (and one rejected) by an upstream.

Wanna
help? [\[https://wiki.ubuntu.com/OperationCleansweep\](https://wiki.ubuntu.com/OperationCleansweep)](https://wiki.ubuntu.com/OperationCleansweep)
