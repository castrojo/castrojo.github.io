...
Corey
[commented](http://www.advogato.org/person/Burgundavia/diary/160.html)
on the state of FF in Linux.

If you’re looking for nicer Tango integration you can grab the theme
[here](https://addons.mozilla.org/en-US/firefox/addon/3766), or install
the Ubuntu package firefox-themes-ubuntu and choose Tango.

Edit: Mike Betlzner
[clarifies](http://www.beltzner.ca/mike/archives/2007/10/11/giving_the_penguin_a_makeover.html).
