...
Want to help Ubuntu but don’t know where to begin? Testing ISOs is a
great way to get started. I’ve [posted this
thread](http://ubuntuforums.org/showthread.php?t=922584) on the forums,
which points to the announcements and resources you’ll need to get
started.
