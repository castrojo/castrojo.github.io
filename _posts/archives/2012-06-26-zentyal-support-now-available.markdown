...
I learned today that Zentyal and Canonical have [teamed
up](http://www.zentyal.com/press/zentyal-to-offer-a-linux-alternative-to-smb-it-infrastructure-with-support-from-canonical/)
to support Zentyal for SMBs.

Zentyal is formally known as eBox and is a nice web UI for services that
run on Ubuntu. So if you’re setting up servers for people that need an
easy to use Web UI to manage their machines then you should check it
out.

If you attended UDS you might remember that we demo’ed Christophe
Sauthier’s [Zentyal
Charm](http://jujucharms.com/~christophe.sauthier/precise/zentyal)
running on GlusterFS in the cloud. Christophe has made it pretty darn
easy to just fire up Zentyal in the cloud, so give it a shot. If you’re
looking to just run it on a single box, you’ll find it in the Ubuntu
archive, enjoy!
