...
I have put together a guide on [how existing Ubuntu teams can use the
Stack
Exchange](http://meta.ubuntu.stackexchange.com/questions/257/am-an-existing-ubuntu-community-member-how-does-stackexchange-work),
since I am seeing a trend of people who might not be familiar with the
concept. We’ll be refining this over time.

After you’re ready [come join us](http://ubuntu.stackexchange.com/) and
help us rock support for users.

![](http://media.tumblr.com/tumblr_l7mecltPZa1qb5bmy.png)
