...
The Pidgin in Ubuntu 7.10 ships with the Bonjour plugin, allowing you to
create adhoc instant messenger contacts with everyone. This is
especially handy at a conference where you can ping people to see what
they are, but not commit to long-term relationships. :)

![Pidgin](http://stompbox.typepad.com/photos/uncategorized/2007/11/03/pidgin.png)
