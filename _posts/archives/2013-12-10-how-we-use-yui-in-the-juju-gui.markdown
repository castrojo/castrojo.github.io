...
Jeff Pihatch from the [Juju GUI](http://juju.ubuntu.com) team was on YUI
In the Wild talking about how we use [YUI](http://yuilibrary.com/) in
the Juju GUI. Full video below:
