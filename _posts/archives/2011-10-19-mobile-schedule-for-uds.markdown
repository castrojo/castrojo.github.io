...
The [guidebook](http://guidebookapp.com/) mobile schedule for UDS-P is
now ready, install it here:

![](http://media.tumblr.com/tumblr_ltbj1eN4hK1qb5bmy.png)

And just search for UDS in the application. Then you’ll have the UDS
schedule, events, sponsorship information, and maps in your pocket:

![](http://media.tumblr.com/tumblr_ltbj83loIG1qb5bmy.jpg)

The schedule updates every 10 minutes, and there’s a convenient QR code
on each schedule page so at UDS itself you’ll be able to just take a
shot of one of the scheduling monitors, or from the QR codes we’ll have
