...
Due to [popular
demand](http://chrisjohnston.org/2010/ubuntu-global-jam-march-2010) I
have added another “How to Run a Bug Jam” session on a weekend (6 March)
to get more coverage.

Check out the [full schedule
here](https://wiki.ubuntu.com/UbuntuGlobalJam).

UPDATE: It’s the 6th of March, I can’t parse dates apparently …
