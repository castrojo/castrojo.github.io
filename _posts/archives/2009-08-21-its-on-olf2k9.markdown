...
![400x300](http://castrojo.files.wordpress.com/2009/08/400x300.png)

Check out [the schedule](http://www.ohiolinux.org/schedule.html). This
year will be awesome. Nuff said.
