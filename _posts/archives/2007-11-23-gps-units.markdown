...
Getting a bit … uh … lost in Maine reminded me that I should probably
invest in a GPS unit for my car.

My friend boskene tells me that the [StreetPilot
c330](https://buy.garmin.com/shop/shop.do?pID=6385#) is pretty easy to
use. Ryan [points
out](http://arstechnica.com/news.ars/post/20071123-nokia-n810-unboxing-and-first-impressions.html)
that software will be available in
[December](http://wayfinder.com/?id=5436) for the Nokia N810. This could
be the excuse I need to buy a N810. Plus, I can use it for more than
just navigation.

Any of you out there using a GPS unit that you totally love and can
recommend?
