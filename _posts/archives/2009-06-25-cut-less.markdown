...
David has
[blogged](http://blog.davebsd.com/2009/06/23/a-tentative-list-of-one-hundred-paper-cuts/)
the set of 100 papercuts that we’re shooting to fix for Karmic. As you
can see [here](https://edge.launchpad.net/hundredpapercuts/karmic) they
are divided into 10 milestones of 10 bugs each. Now we have a nice
concrete list of bugs that are attainable.

Please see [Jean-Louis
Dupond](https://bugs.edge.launchpad.net/ubuntu/+source/nautilus/+bug/57210)’s
bug as an example of Doing It The Right Way(tm) by working upstream. On
a related note, the word “Ubuntu” is no longer considered a
[misspelling](https://bugs.edge.launchpad.net/ubuntu/+source/aspell-en/+bug/15200).
