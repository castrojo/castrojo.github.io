...
Please don’t forget to add your team to the [Event
List](https://wiki.ubuntu.com/UbuntuGlobalJam/Events) if you’re planning
on running a jam as part of the [Global
Jam](https://wiki.ubuntu.com/UbuntuGlobalJam/)! People can’t show up to
your wonderfully planned event if they don’t know about it!
