...
I always do my presentations in PDF because it’s a common format.
Sometimes however I want to add in a slide or remove a slide when I find
out I messed something up but don’t have time to go edit the
presentation and re export it.

For Maverick’s Featured Apps we now have
[PDFMod](http://live.gnome.org/PdfMod), for quick an easy manipulation
of PDFs.

![](http://media.tumblr.com/tumblr_l93xrcKMKo1qb5bmy.png)

PDFMod is written by these [fine
people](http://git.gnome.org/browse/pdfmod/tree/AUTHORS) and packaged up
for you by [this](https://edge.launchpad.net/~hyperair) fine person.
