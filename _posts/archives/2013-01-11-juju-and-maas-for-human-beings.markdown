...
Sometimes it’s easy to forget that while our audience might be very
technical, it doesn’t mean they exactly understand what your stuff does.
This is especially true of new projects like
[MAAS](http://maas.ubuntu.com), which brings the convenience of the
cloud to your datacenter, or with [Juju](http://juju.ubuntu.com), which
orchestrates your deployments. So, in an effort to cut through the
alphabet soup, we’ve made two videos that explain what each of them
does, and how they can help making cloud computing more accessible to
everyone.
...
And you can check them both out at the newly launched
[Juju](http://juju.ubuntu.com) and [MAAS](http://maas.ubuntu.com)
websites.
