...
Thanks to PiTiVi I was able to take the [webm
files](http://www.flumotion.com/first_webm_live_event.php) from GUADEC
and put together a video of Gabriel’s [Banshee](http://banshee.fm) talk.

Those of you wondering how to make Banshee extensions (Stuart!) will
want to pay attention around the 5 minute mark, where he goes into an
example on how easy it is to make an extension. 

[![](http://a.images.blip.tv/Ubuntudevelopers-InsideTheBansheeAwesomeFactory422-306.jpg)](http://ubuntudevelopers.blip.tv/file/4363767/)
