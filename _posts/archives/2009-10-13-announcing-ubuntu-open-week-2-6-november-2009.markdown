...
![ubuntu-openweek-small](http://castrojo.files.wordpress.com/2009/10/ubuntu-openweek-small.png)

It’s that time of the year folks. Ubuntu Open Week, the IRC workshop
that’s taking the world by storm. We’ve got a [great
schedule](https://wiki.ubuntu.com/UbuntuOpenWeek/) of talks for you from
some really great people from the Ubuntu Community. The [wiki
page](https://wiki.ubuntu.com/UbuntuOpenWeek/) has all the information
you need to participate. Hope to see you there!

Update: Speak Spanish? If so, there’s an entire week of Spanish Open
Week goodness available as well, thanks to the people who put that
together!
